...
using City_Shop.Uitilities.Exceptions;
...
namespace City_Shop.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(CityShopDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new CityShopException($"Cannot find a product: {productId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new CityShopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new CityShopException($"Cannot find a product with id: {productId}");
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            if (productImage == null)
                throw new CityShopException($"Cannot find an image with id {imageId}");
